    ...
    <div className="flex flex-col border rounded-md pb-4 max-md:border-none max-md:shadow-xl">
      ...
      <div className="px-6 flex flex-col gap-y-4 mt-4">
        <span className="max-w-2xl">
          <img src={FeedData.type} alt="type img" />
        </span>
        ...
        {FeedData.content ? (
          <div className="text-lg text-gray-600">{FeedData.content}</div>
        ) : (
        ...
        {FeedData.buttonText ? (
          <button
            className={`w-full border rounded-lg h-12 ${FeedData.buttonTextColor}`}
          >
            {FeedData.buttonText}
          </button>
        ) : null}
