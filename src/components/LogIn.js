        ...
        <div className='py-6 px-6 flex items-center justify-between max-md:justify-center gap-x-4 w-full'>
            <div className='w-1/2 h-[26rem] flex flex-col gap-y-6 max-md:w-[24rem] max-xxs:w-full'>
                <div className='font-semibold text-xl flex justify-start max-md:justify-between items-center'>
                    Sign In
                    <button className='text-white font-bold bg-black rounded-full text-base p-[1.5px] flex items-center justify-center md:hidden' onClick={handleClose}><RxCross2/></button>
                </div>
                ...
                <div className='flex items-center justify-between'>
                    ...
                    <button className='underline md:hidden text-sm hover:text-[#2F6CE5]' onClick={() => {setIsLogin(false)}}>or, Create Account</button>    
                </div>
