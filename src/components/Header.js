...
const Header = () => {
    return (
        <div className= "h-20 flex items-center justify-between px-24">
            <img src={logo} alt="logo" className=""/>
            <div className = "w-96  h-11 px-4 flex items-center justify-start gap-x-4 rounded-full bg-gray-200 text-gray-600 ">
                <IoSearch/>
